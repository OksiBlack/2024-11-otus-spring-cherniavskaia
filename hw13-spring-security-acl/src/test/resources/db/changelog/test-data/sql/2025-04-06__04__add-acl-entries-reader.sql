...
(1, 5, (SELECT id FROM acl_sid WHERE sid = 'ROLE_READER'), 1, TRUE, TRUE, TRUE),  -- Access for Tolkien
(2, 5, (SELECT id FROM acl_sid WHERE sid = 'ROLE_READER'), 1, TRUE, TRUE, TRUE),  -- Access for Pushkin
(3, 5, (SELECT id FROM acl_sid WHERE sid = 'ROLE_READER'), 1, TRUE, TRUE, TRUE),  -- Access for Lermontov
(4, 5, (SELECT id FROM acl_sid WHERE sid = 'ROLE_READER'), 1, TRUE, TRUE, TRUE);  -- Access for Dostoevsky
