...
public class JpaUserDetailsService implements JpaUserDetailsManager {
    ...
    public void updateUser(UserDetails user) {
        ...
        User foundUser = userRepository.findByLogin(bookStoreUser.getLogin())
            .orElseThrow(() -> new EntityNotFoundException(
                "No user with login: [%s]".formatted(bookStoreUser.getLogin()))
            );

        foundUser.setBirthday(bookStoreUser.getBirthday());
        foundUser.setLastName(bookStoreUser.getLastName());
        foundUser.setFirstName(bookStoreUser.getFirstName());
        foundUser.setMiddleName(bookStoreUser.getMiddleName());
        foundUser.setPassword(bookStoreUser.getPassword());
        foundUser.setEmail(bookStoreUser.getEmail());
        foundUser.setRoles(bookStoreUser.getRoles());
        userRepository.save(bookStoreUser);
    }
