...
@Import({CommentMapper.class, CommentServiceImpl.class,
    BookMapper.class, AuthorMapper.class,
    GenreMapper.class, BookServiceImpl.class})
...
@Transactional(propagation = Propagation.NEVER)
 class CommentServiceImplTest {
    ...
    void testFindById_NotFound() {
        Optional<CommentDto> foundComment = commentService.findById(999L); // Non-existent ID
