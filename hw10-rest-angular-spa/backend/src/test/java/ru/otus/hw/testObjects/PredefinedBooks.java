...
public class PredefinedBooks {
    ...
    public static Map<String, BookDto> getBookDtoMap() {
        // Adding predefined books to the map using constant strings
        BOOKS_DTO_MAP.put(PredefinedBooks.HOBBIT_ID, PredefinedBooks.Dtos.HOBBIT);
        BOOKS_DTO_MAP.put(PredefinedBooks.LORD_FELLOWSHIP_ID, PredefinedBooks.Dtos.LORD_FELLOWSHIP);
        BOOKS_DTO_MAP.put(PredefinedBooks.LORD_TWO_TOWERS_ID, PredefinedBooks.Dtos.LORD_TWO_TOWERS);
        BOOKS_DTO_MAP.put(PredefinedBooks.LORD_RETURN_OF_THE_KING_ID, PredefinedBooks.Dtos.LORD_RETURN_OF_THE_KING);
        BOOKS_DTO_MAP.put(PredefinedBooks.EUGENE_ONEGIN_ID, PredefinedBooks.Dtos.EUGENE_ONEGIN);
        BOOKS_DTO_MAP.put(PredefinedBooks.HERO_OF_OUR_TIME_ID, PredefinedBooks.Dtos.HERO_OF_OUR_TIME);
        BOOKS_DTO_MAP.put(PredefinedBooks.FATALIST_ID, PredefinedBooks.Dtos.FATALIST);
        BOOKS_DTO_MAP.put(PredefinedBooks.CRIME_AND_PUNISHMENT_ID, PredefinedBooks.Dtos.CRIME_AND_PUNISHMENT);
        BOOKS_DTO_MAP.put(PredefinedBooks.BROTHERS_KARAMAZOV_ID, PredefinedBooks.Dtos.BROTHERS_KARAMAZOV);
