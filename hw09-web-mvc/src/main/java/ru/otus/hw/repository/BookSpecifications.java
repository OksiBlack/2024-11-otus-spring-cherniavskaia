...
public class BookSpecifications {
    ...
    public static Specification<Book> hasSerialNumber(String serialNumber) {
        return (root, query, criteriaBuilder) ->
            !StringUtils.isEmpty(serialNumber) ? criteriaBuilder.equal(root.get("serialNumber"), serialNumber) : null;
    }

    public static Specification<Book> hasDescriptionLike(String description) {
        return (root, query, criteriaBuilder) ->
            !StringUtils.isEmpty(description) ? criteriaBuilder.like(root.get("description"), "%" + description + "%") : null;
    }
