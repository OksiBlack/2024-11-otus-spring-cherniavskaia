...
public class StreamIOService implements IOService {
    ...
    @Override
    public Set<Integer> readAllIntsForRangeWithPrompt(int min, int max, String prompt, String errorMessage) {
        printLine(prompt);
        return readAllIntsForRange(min, max, errorMessage);
    }
    ...
    public int readIntForRange(int min, int max, String errorMessage) {
        ...
        throw new IllegalArgumentException("Error on reading int value");
    }
