...
INSERT INTO books (title, description, serial_number, isbn, author_id)
SELECT 'Fatalist', 'A story portraying the inner conflicts and explorations of characters facing unlikely situations, linked to fate and free will.', 'SN008', '978-0-14-044533-6', (SELECT id FROM authors WHERE last_name = 'Lermontov');
