...
class JdbcBookRepositoryTest {
    ...
    void shouldSaveNewBook() {
        var expectedBook = new Book(0, "BookTitle_10500", "", List.of(dbAuthors.get(0)),
    ...
    void shouldSaveUpdatedBook() {
        var expectedBook = new Book(1L, "BookTitle_10500", "description 1",  List.of(dbAuthors.get(4), dbAuthors.get(5)),
