...
public class LocalizedIOServiceImpl implements LocalizedIOService {
    ...
    @Override
    public Set<Integer> readAllIntsForRangeWithPrompt(int min, int max, String prompt,
                                                      String errorMessage) {
        return ioService.readAllIntsForRangeWithPrompt(min, max, prompt, errorMessage);
    }

    @Override
    public Set<Integer> readAllIntsForRange(int min, int max, String errorMessage) {
        return ioService.readAllIntsForRange(min, max, errorMessage);
    }
    ...
    @Override
    public Set<Integer> readAllIntsForRangeWithPromptLocalized(int min, int max, String promptCode,
                                                               String errorMessageCode) {
        return ioService.readAllIntsForRangeWithPrompt(min, max,
            localizedMessagesService.getMessage(promptCode),
            localizedMessagesService.getMessage(errorMessageCode)
        );
    }
    ...
    @Override
    public Set<Integer> readAllIntsForRangeLocalized(int min, int max, String promptCode, String errorMessageCode) {
        return ioService.readAllIntsForRangeWithPrompt(min, max,
            localizedMessagesService.getMessage(promptCode),
            localizedMessagesService.getMessage(errorMessageCode)
        );
